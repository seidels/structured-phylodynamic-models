...
scInfDir="/Volumes/Stadler/cEvoUnpublished/2018-Sophie-CompBDSC/simstudy_3/data/summary_data/sc_inf/SC/forwardExp/"
...
p <- ggplot(data = subset(newmetric,subset = parameter == "mr01" ), aes(x=case, y = value, shape=Model))+
  ...
  facet_wrap(.~metric, scales = "free", labeller = labeller(label_both)) + theme_light() + 
  geom_errorbar(aes(ymin=value-sd/2, ymax=value + sd/2), 
                width=0.1, position = position_dodge(0.2))  +
